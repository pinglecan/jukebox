...
Route::get("/playlist/TempPlaylist", [PlaylistController::class, 'TempPlaylist'])->name('playlist.TempPlaylist');
Route::post("/playlist/storeTemp", [PlaylistController::class, 'storeTempPlaylist'])->name('playlist.storeTempPlaylist');
